...
const SERIES_DATA = [
  ...
  { title: 'True Beauty', slug: 'true-beauty', type: 'manhwa', alt: ['여신강림', 'Gerçek Güzellik'], desc: 'Makyaj ustası Jugyeong, okuldaki popülerliğini makyajsız yüzünün sırrını saklayarak korumaya çalışır.', author: 'Yaongyi', artist: 'Yaongyi', year: 2018, age: '13+', genres: ['Romantizm', 'Komedi', 'Okul', 'Slice of Life'], status: 'Tamamlandı', tStatus: 'Tamamlandı', featured: false, chapters: 120 },
  ...
  { title: 'Windbreaker', slug: 'windbreaker-webtoon', type: 'webtoon', alt: ['윈드브레이커'], desc: 'Jay, bisiklet yarışı takımına katılarak yeni arkadaşlar edinir ve yarış dünyasının heyecanını keşfeder. Rüzgarı arkasına alarak zirveye koşar.', author: 'Jo Yongseok', artist: 'Jo Yongseok', year: 2013, age: '13+', genres: ['Spor', 'Komedi', 'Okul', 'Slice of Life'], status: 'Bırakıldı', tStatus: 'Bırakıldı', featured: false, chapters: 165 },
  { title: 'Hardcore Leveling Warrior', slug: 'hardcore-leveling-warrior', type: 'webtoon', alt: ['열렙전사', 'Sert Seviye Savaşçısı'], desc: 'Lucid Adventure oyununun 1 numaralı oyuncusu, hacklenerek tüm seviyelerini kaybeder. Sıfırdan başlayarak tekrar zirveye tırmanmaya çalışır.', author: 'Kim Sehoon', artist: 'Kim Sehoon', year: 2016, age: '16+', genres: ['Aksiyon', 'Fantastik', 'Oyun', 'Komedi'], status: 'Tamamlandı', tStatus: 'Tamamlandı', featured: false, chapters: 150 },
]
